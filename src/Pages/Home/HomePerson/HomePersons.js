      ...
      <div className="block text-center m-auto">
        {!showAll && (
          <button
            ...
            className="font-inter py-2 px-4 text-[#272D37] border-[#DAE0E6] border-2 rounded-full hover:shadow hover:bg-primaryColor hover:text-white hover:border-transparent"
          >
            Load more
          </button>
        )}
